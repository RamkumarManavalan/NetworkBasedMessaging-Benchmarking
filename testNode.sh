...
do
  a=`expr $a + 1`
  data='{"data":{"name":"Ram", "age":10}, "endpoint":"http://10.9.216.220:7080/users", "delayby":'$delayby'}'
  curl -s -X POST -H "Content-Type: application/json" -d "$data" http://10.9.216.220:7070/delayby | grep -v  endpoint
